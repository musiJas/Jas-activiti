...
import cn.begonia.project.autoconfigure.jasactivitiautofigure.starter.util.HttpUtil;
...
public class ModelerController{
    ...
    public void create(HttpServletRequest request,HttpServletResponse response, String name, String key) throws IOException {
        ...
        response.sendRedirect(HttpUtil.getContextPath(request)+"/editor?modelId="+ model.getId());
